...
<body>
    ...
    <!-- Tabela de login -->
        ...
        <h4 style="text-align:center">Modificar Registro</h4>
        <form runat="server">
            ...
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" style="margin-left: 240px;">Entrar</button>
